...
public class JTetromino extends Tetromino {
	...
	public JTetromino() {
		...
		// 0 - UP
//		rotations[0][0][0] = new Block(color);
...
//		rotations[3][2][1] = new Block(color);
		...
		rotation[2][3] = new Block(color,new int[] {2,2});
		
		// 3 - LEFT
		rotation[3][0] = new Block(color,new int[] {2,0});
